...
def create_examples(input_file, set_type, slot_list, domain_list, occur_list,
                    label_maps={},
    ...
    for entry in input_data:
        ...
        for turn_id, turn in enumerate(entry['turns']):
            ...
            for slot_i, value_i in value_dict.items():
                for slot_j, value_j in value_dict.items():
                    # refer
            ...
            pre_diag_seen_slots_value_dict = value_dict.copy()

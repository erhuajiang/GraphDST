...
def create_examples(input_file, acts_file, set_type, slot_list, domain_list, occur_list, slot_description,
                    label_maps={},
    ...
    for domain in domain_list:
        node_description.append(tokenize(domain))
    for slot in slot_list:
        node_description.append(tokenize(slot_description[slot]))
